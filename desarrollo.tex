...
\section{Implementación B}
	...
	Si no que, ante una operación \code{V\(\)} que se realiza sobre un mútex, la tarea cuya prioridad fue cambiada pasa al estado \emph{ready to run} con la prioridad vieja.
	Esto generó que se abandonara esta implementación y se pensara en una nueva donde las prioridades fuesen fijas.
